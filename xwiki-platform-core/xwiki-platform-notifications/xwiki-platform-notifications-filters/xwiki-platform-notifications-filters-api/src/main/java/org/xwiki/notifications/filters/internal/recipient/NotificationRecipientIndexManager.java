...
/**
 * Manages per-wiki notification recipient indexes.
 *
 * @version $Id$
 * @since 18.4.0
 */
@Role
public interface NotificationRecipientIndexManager
{
    /**
     * Get or build the recipient index for the specified wiki.
     *
     * @param wikiId the wiki identifier
     * @return the recipient index
